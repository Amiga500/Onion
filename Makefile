...
.PHONY: all version core apps external release clean deepclean git-clean with-toolchain patch lib test unit-test unit-test-asan unit-test-clean check-no-system
