...
/*
 * Miyoo Flip (RK3566) hardware button → Linux input event code mapping.
 * These keycodes must be verified against the actual kernel GPIO driver
 * or device tree configuration on the Miyoo Flip hardware.
 * Default mapping assumes same logical layout as Miyoo Mini.
 */
...
#else
/* Miyoo Mini / Mini+ (SSD202D/SSD212) hardware button mapping */
