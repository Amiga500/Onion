...
> **20 commits** · **139 files** · **+26,906 / −753 lines** · **8 NEON kernels** · **68 test suites** · **1,410 tests** · **71,385 assertions** · **ALL PASSED** ✅
...
> it describes, so its own SHA cannot appear here — the code tip is `927685e8` (on top of merge
> `e44421e1`, which brought in PR #206–207 from the remote `OnionPlus` branch) and the docs
...
| | | *Code only, excluding `docs/`* | *137* | *+25,509 / −753* | |

> ℹ️ **Of the 20 commits, 18 are hand-written engineering work.**
...
> 2026-08-23; the docs refresh describing them is the unnumbered commit on top of `927685e8`.
...
```bash
git diff --shortstat 07505ea5 927685e8            # code tip (docs refresh excluded)
git diff --numstat  07505ea5 927685e8
git diff --shortstat 07505ea5 927685e8 -- src/ test/ docs/ Makefile
make unit-test
```
...
- **Expect a "17 vs N" discrepancy against GitHub release notes** that compare a tag range
  ...
  `07505ea5` → `927685e8` delta (the docs refresh sits on top, unnumbered).
...
Base: [`07505ea5`](https://github.com/Amiga500/Onion/commit/07505ea5) → Tip: [`927685e8`](https://github.com/Amiga500/Onion/commit/927685e8) + docs refresh ·
