...
| 🛡️ `action_loadGame` slot bounds check | `< 0 && >= slot_count` — untriggerable dead code | changed to OR ([`ff012faa`](https://github.com/Amiga500/Onion/commit/ff012faa)) | **out-of-range slots rejected** | 🛡️ |
