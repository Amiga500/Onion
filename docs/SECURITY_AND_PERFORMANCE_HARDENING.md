...
**Target Hardware:** Miyoo Mini / Mini+ (ARM Cortex-A7 single-core ~1.2 GHz, NEON VFPv4, 128–256 MB RAM)  
**Date:** February 2026  
...
This document details all security hardening, crash fixes, battery optimizations, and infrastructure improvements applied to the Onion OS codebase on this branch. Changes span **40+ C source/header files**, **1 shell script**, and add a **performance timing framework** and **unit test infrastructure**.
