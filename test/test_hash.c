...
TEST(hash_basic_string) {
    // Add +8 buffer as required by hash function
    char *str = (char *)malloc(strlen("hello") + 1 + 8);
    strcpy(str, "hello");
...
TEST(hash_different_strings) {
    ...
    char *str1 = (char *)malloc(strlen("hello") + 1 + 8);
    char *str2 = (char *)malloc(strlen("world") + 1 + 8);
    strcpy(str1, "hello");
    strcpy(str2, "world");
...
TEST(hash_long_string) {
    ...
    char *str = (char *)malloc(strlen(text) + 1 + 8);
    strcpy(str, text);
    uint32_t hash = FNV1A_Pippip_Yurii(str, strlen(str));
    ASSERT_GT(hash, 0);
    free(str);
...
TEST(hash_case_sensitive) {
    ...
    char *str1 = (char *)malloc(strlen("Hello") + 1 + 8);
    char *str2 = (char *)malloc(strlen("hello") + 1 + 8);
    strcpy(str1, "Hello");
    strcpy(str2, "hello");
...
TEST(hash_short_strings) {
    ...
    for (int i = 0; i < 8; i++) {
        char *str = (char *)malloc(strlen(short_strs[i]) + 1 + 8);
...
TEST(hash_slightly_different) {
    ...
    char *str1 = (char *)malloc(strlen("test123") + 1 + 8);
    char *str2 = (char *)malloc(strlen("test124") + 1 + 8);
    strcpy(str1, "test123");
    strcpy(str2, "test124");
