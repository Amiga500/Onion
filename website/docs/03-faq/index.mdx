...
:::note
The *Game manual* option is not displayed in GLO menu if the pdf file doesn't exist or if it is not well named (the file names are case sensitive).
:::
...
* This will invoke the 'Refresh All Roms' menu option, press <kbd>A</kbd> to confirm.   
