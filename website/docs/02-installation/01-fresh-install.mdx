...
:::caution Beware
The SD card included with the MM is known to be slow, and will likely ruin your experience and/or data.
...
1. Copy your ROM files into their respective subfolders in `Roms`. See the *[Emulators](../emulators)* page for more information - there you'll find the [Rom Folders](../emulators/folders) table.
2. If required by your installed emulators, copy the BIOS files into the `BIOS` folder. See Libretro's *[core specific BIOS information](https://docs.libretro.com/library/bios/#links-to-the-core-specific-bios-information)* for more details.
