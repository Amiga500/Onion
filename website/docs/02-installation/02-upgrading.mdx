...
The MMP can update Onion via the Wi-Fi connection using the OTA Update app. If the OTA update fails, simply follow the steps below to perform a manual update.
:::
...
1. The installation will begin when you boot up your MM.
