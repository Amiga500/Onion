...
Select a game and then press <kbd>Y</kbd> to display the GLO menu and find the "Netplay" option in the list.
You will note that Onion now automatically selects the best core for your Netplay session.
...
- **[Easy Netplay](multiplayer/easynetplay)**
  ...
  When you have two MMP in the same room, "Easy Netplay" lets you play a multiplayer game without any configuration, as it requires no prior Wi-Fi setup.
