...
Press <kbd>Y</kbd> in a game list, then from this menu you can choose the RetroArch core, download the image cover of your game (Wi-Fi/MMP required), launch a Netplay session, reset your game (to skip the last save state), filter the list of games with a keyword, and more.
