...
> If newly added games are still not appearing, ensure that you have placed them in the [correct rom folders](emulators#rom-folders---quick-reference).  
...
> Notes:  
> [Rom folders](emulators#rom-folders---quick-reference) and [Bios](emulators#bios-files) filenames are case sensitive.  
